...
<#if generateLayout>
    ...
    <instantiate from="root/src/app_package/Adapter.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/module/${fragmentClass}/${fragmentClass}Adapter.java" />
    ...
    <open file="${escapeXmlAttribute(srcOut)}/module/${fragmentClass}/${fragmentClass}ListRes.java" />
    <open file="${escapeXmlAttribute(srcOut)}/module/${fragmentClass}/${fragmentClass}Adapter.java" />

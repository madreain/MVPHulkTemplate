...
<#if generateLayout>
    ...
    <instantiate from="root/src/app_package/Fragment.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/module/${fragmentClass}/${fragmentClass}DialogFragment.java" />
    ...
    <open file="${escapeXmlAttribute(srcOut)}/module/${fragmentClass}/${fragmentClass}DialogFragment.java" />
